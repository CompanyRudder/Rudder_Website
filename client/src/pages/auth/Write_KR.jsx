...
export default function Write_KR({ admin }) {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      //--DB INSERT
      axios
        .post("/api/insertPortfolio", { data })
        .then(() => {
          console.log("SUCCESS");
          alert("업로드 완료 되었습니다!");
          navigate("/auth/delete_kr");
        })
